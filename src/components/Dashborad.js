...
function Dashborad() {
  ...
  return (
    <div className="whitebackgroundoffers">
      <div style={{ alignSelf: "center" }} className="center">
      ...
      >
        <div className="dashcard">
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            <h6 className="cardtitle">Total Dests created</h6>
          </div>
        </div>
        <div className="dashcard">
          <IoIosStats
