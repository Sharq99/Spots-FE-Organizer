...
import PushDestList from "./PushDestList";
...
function PushNotification() {
  ...
  const handleSubmitEnglish = async (event) => {
    ...
    try {
      await pushNotificationStore
        .createPushNotification(newPushNotification)
        .then(
          swal({
      ...
      <div className="whitebackgroundoffers">
        ...
        <div className="whitebackgroundcreate">
          ...
          >
            ...
            <div style={{ width: "100%", marginTop: 50, marginLeft: 0 }}>
              <PushDestList setSpotId={setSpotId} spotId={spotId} />
            </div>
          </div>
        </div>
      </div>
